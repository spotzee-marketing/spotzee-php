...
namespace SpotzeeApi\Http;

use SpotzeeApi\Base;
use SpotzeeApi\Cache\CacheAbstract;
use SpotzeeApi\Params;
use Exception;

/**
 * Class Request
 * @package SpotzeeApi\Http
 */
class Request extends Base
{
    ...
    public function send(): Response
    {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT, 'Spotzee API Client version '. Client::CLIENT_VERSION);
