...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://cp.spotzee.marketing/backend/assets/css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="https://cp.spotzee.marketing/backend/assets/css/bootstrap-glyphicons.css" />
    <link rel="stylesheet" type="text/css" href="https://cp.spotzee.marketing/backend/assets/css/style.css" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="https://cp.spotzee.marketing/backend/assets/js/bootstrap.js" id="script-bootstrap"></script>
    <link rel="shortcut icon" href="https://cp.spotzee.marketing/favicon.ico" type="image/x-icon" /> 
...
<div class="col-lg-4" id="content">
    <!--
    The form below is generated by Spotzee Marketing App.
